...
router.post("/delivery/courier",AuthorizationPharmacy,FactorController.deliveryToCourier)
router.post("/delivery/person",AuthorizationPharmacy,FactorController.deliveryToPerson)
